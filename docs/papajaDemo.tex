...
We used R {[}Version 4.0.2; R Core Team (2018){]} and the R-packages \emph{academicWriteR} {[}Version 0.4.1; Casillas (n.d.){]}, \emph{dplyr} {[}Version 1.0.6; Wickham, François, Henry, and Müller (2019){]}, \emph{faux} {[}Version 1.0.0; DeBruine (2019){]}, \emph{forcats} {[}Version 0.5.1; Wickham (2018){]}, \emph{ggplot2} {[}Version 3.3.3; Wickham (2016){]}, \emph{papaja} {[}Version 0.1.0.9997; Aust and Barth (2018){]}, \emph{purrr} {[}Version 0.3.4; Henry and Wickham (2019){]}, \emph{readr} {[}Version 1.4.0; Wickham, Hester, and Francois (2018){]}, \emph{stringr} {[}Version 1.4.0; Wickham (2019){]}, \emph{tibble} {[}Version 3.1.2; Müller and Wickham (2019){]}, \emph{tidyr} {[}Version 1.1.3; Wickham and Henry (2019){]}, and \emph{tidyverse} {[}Version 1.3.1; Wickham (2017){]} for all our analyses.
